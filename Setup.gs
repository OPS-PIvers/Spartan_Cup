...
function onOpen() {
  SpreadsheetApp.getUi()
    ...
    .addItem('9. Start New Season (Reset Season Points)', 'startNewSeasonDialog')
    .addSeparator()
...
function setupSpreadsheet() {
  ...
  const sheets = {
    ...
    'Submissions_Pending': ['Submission_ID', 'Timestamp', 'Email', 'Event_ID', 'Photo_URL', 'Photo_ID', 'Location_Data_JSON', 'Dressed_For_Theme', 'Notes', 'Share_In_Fan_Feed'],
    'Submissions_Verified': ['Submission_ID', 'Timestamp_Submitted', 'Timestamp_Approved', 'Email', 'Event_ID', 'Admin_Email', 'Points_Base', 'Points_Theme', 'Points_Spotlight_Multiplier', 'Points_Total', 'Photo_URL', 'Photo_ID', 'Share_In_Fan_Feed'],
